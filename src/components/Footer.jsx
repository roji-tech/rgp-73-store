		...
		<footer className="footer">
			<div className="footer-row">
				...
				<div>
					...
					<ul>
						<li>
							<Link to={"/rgp-73-store"}>home </Link>
						</li>
						<li>
							<Link to={"/rgp-73-store/about/"}>about </Link>
						</li>
						<li>
							<Link to={"/rgp-73-store/products"}>products </Link>{" "}
						</li>
						<li>
							<Link to={"/rgp-73-store/contact"}>contact </Link>{" "}
						</li>
					</ul>
				</div>
			</div>
